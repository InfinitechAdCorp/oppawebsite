...
export default function MenuItemModal({ item, children }: MenuItemModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md mx-auto bg-gradient-to-br from-red-800 via-orange-700 to-amber-700 border-0 text-white">
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full text-lg py-6 bg-white/90 text-orange-600 hover:bg-white hover:text-orange-700 font-bold shadow-lg backdrop-blur-sm border border-white/30 transition-all duration-300"
              size="lg"
            >
