...
const OrderDetailsModal = ({ order, onClose }: OrderDetailsModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="bg-gradient-to-br from-gray-900 to-black border-yellow-400/30 shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <CardHeader className="border-b border-white/10">
          <div className="flex justify-between items-start">
            <div>
              <CardTitle className="text-xl text-yellow-400">Order Details - #{order.id}</CardTitle>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="flex gap-3 pt-4">
            <Button
              variant="outline"
              className="border-yellow-400/50 text-yellow-400 hover:bg-yellow-400/20 bg-transparent"
            >
